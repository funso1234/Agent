  ...
  return (
    ...
    backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
        ...
        <img src={theme === 'dark' ? assets.logo_dark : assets.
            ...
            <div className={`text-gray-700 dark:text-white sm:text-sm ${!sidebarOpen ? 'max-sm:w-0 overflow-hidden' : 'max-sm:w-50 max-sm:pl-10'} max-sm:fixed top-0 
            bottom-0 right-0 max-sm:min-h-screen max-sm:h-full max-sm:flex-col 
            ...
            <div className='flex items-center gap-2 sm:gap-4'>
              ...
              <ThemeTogglerBtn theme={theme} setTheme={setTheme}/>
